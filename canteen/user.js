...
class MainPanel {
    ...
    createToolsPanel() {
        ...
        this.toolImgs.img1.on('change', function (boolValue) { that.onChangeImageButton('kctw', boolValue); });
        this.toolImgs.img2.on('change', function (boolValue) { that.onChangeImageButton('yptw', boolValue); });
